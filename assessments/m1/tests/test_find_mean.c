...
int main(void) {
    ...
    test_find_mean(test_array_1, array_length_1, expected_max_1, "{2}");

    unsigned char test_array_2[] = {34, 201, 190};
    unsigned int array_length_2 = 3;
    char expected_max_2 = 141;
    test_find_mean(test_array_2, array_length_2, expected_max_2, "{34,201,190}");

    unsigned char test_array_3[] = {201, 201, 201};
    unsigned int array_length_3 = 3;
    char expected_max_3 = 201;
    test_find_mean(test_array_3, array_length_3, expected_max_3, "{201,201,201}");
    ...
    char expected_max_4 = 105;
    test_find_mean(test_array_4, array_length_4, expected_max_4, "{34,201,190,154,8,194,2,4,45,88,76,123,99,56,233,212,34,57,165,142}");
